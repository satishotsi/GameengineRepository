package com.pycker.gameengine.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.pycker.gameengine.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.pycker.gameengine.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.pycker.gameengine.domain.Contest.class.getName() + ".announcements");
