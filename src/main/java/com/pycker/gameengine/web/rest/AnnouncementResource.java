...
import com.pycker.gameengine.repository.AnnouncementRepository;
...
/**
 * REST controller for managing {@link com.pycker.gameengine.domain.Announcement}.
 */
@RestController
@RequestMapping("/api")
public class AnnouncementResource {
    ...
    public ResponseEntity<Announcement> updateAnnouncement(@RequestBody Announcement announcement) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, announcement.getId().toString()))
            .body(result);
    }
